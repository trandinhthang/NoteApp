...
class PriorityList extends Component{
    ...
    saveLoadData = async() => {
        try{
            ...
            this.id++;
            //set item 
            await AsyncStorage.setItem("ListPriority", JSON.stringify(this.arrBf))
    ...
    async componentDidMount(){
       this.setState({
        ...
        // this.arrAf=JSON.parse(await AsyncStorage.getItem("ListPriority")) //array after
    }
    //set modal
            ...
            <View style={{height:'100%'}}>
                ...
                {this.state.itemP ? 
                    ...
                    <View key={index} style={Styles.listItem}>
                        ...
                        <Text style={{fontSize:20, color:'gray'}}> Priority Empty</Text>   
                    </View>
                } 
                    <Modal
                        animationType="slide"
                    ...
                    >
                        <View style={{margin:10,marginTop:50,height:300,backgroundColor:'#a5d5fa'}}>
                            ...
                            >
                                <Text style={{color:'white',fontSize:20}}>Add Priority </Text>
                            </View>
